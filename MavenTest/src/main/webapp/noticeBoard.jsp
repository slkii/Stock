...
<body class="nav-fixed">
		...
		<ul class="navbar-nav align-items-center ms-auto">
			...
			<li
				...
				<div
					...
					<h6 class="dropdown-header dropdown-notifications-header">
						<i class="me-2" data-feather="mail"></i> Message Center
					</h6>
					<!-- Example Message 1  -->
					<a class="dropdown-item dropdown-notifications-item" href="#!">
	...
	<div id="layoutSidenav">
						...
						<div class="collapse" id="collapseApps"
							...
							<nav class="sidenav-menu-nested nav accordion"
								...
								<a class="nav-link collapsed" href="javascript:void(0);"
									...
									aria-expanded="false" aria-controls="appsCollapseKnowledgeBase">
									Knowledge Base
									<div class="sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								...
								<a class="nav-link collapsed" href="javascript:void(0);"
									...
									aria-expanded="false"
									aria-controls="appsCollapseUserManagement"> User Management
									<div class="sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
								<div class="collapse" id="appsCollapseUserManagement"
									...
									<nav class="sidenav-menu-nested nav">
										<a class="nav-link" href="user-management-list.html">Users
											...
											href="user-management-edit-user.html">Edit User</a> <a
											class="nav-link" href="user-management-add-user.html">Add
								...
								<a class="nav-link collapsed" href="javascript:void(0);"
									...
									aria-expanded="false"
									aria-controls="appsCollapsePostsManagement"> Posts
									Management
									<div class="sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
		...
		<div id="layoutSidenav_content">
			<main>
				<header
					class="page-header page-header-dark bg-gradient-primary-to-secondary mb-4">
						...
						<div class="page-header-content pt-4">
							<div class="row align-items-center justify-content-between">
								<div class="col-auto mt-4">
									...
									<div class="page-header-subtitle">QnA</div>
								</div>
							</div>
				...
				%>
				<button class="btn btn-outline-blue" type="button" onclick="href='noticeEdit.jsp'">수정</button>
				<button class="btn btn-outline-blue" type="button" >삭제</button>
		</div>
